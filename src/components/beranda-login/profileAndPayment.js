...
class ProfileAndPayment extends Component {
    ...
    render(){   
        ...
        let { type, status } = this.props.match.params;
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Form inline>
                    ...
                    <div>
                        ...
                        >   
                            <Dropdown.Item eventKey="1" href="/"><i className='fas fa-home pr-2'></i> Home</Dropdown.Item>
                            <Dropdown.Item eventKey="2" href={"/logpay/profile/" + status}> <i className='fas fa-user pr-2'></i> Profile</Dropdown.Item>
                            <Dropdown.Item eventKey="3" href={"/logpay/pay/" + status }> <i className='fas fa-money-check-alt pr-1'></i> Pay</Dropdown.Item>
                ...
                <div style={{paddingBottom:"250px"}}>
                    ...
                    {
                        type === 'profile' ?(
                    <Container className="mr-auto ml-auto bg-dark mt-5 mb-5" style={{width: 700, height: 435, borderRadius: 10}}>
                        <Row className="pt-3">
                            <Col xs={4} md={6} className="text-white">
                                ...
                                <div className="pl-2 pt-4">
                                    <div className="d-inline-flex">
                                        <i className='fas fa-address-card pr-2 pt-2' style={{width: 30, color: '#E50914'}}></i>
                                        <div>
                                            <h6>{status}</h6>
                                            <span className="text-secondary" style={{fontSize: 12, marginTop: "-10px", position: "absolute"}}>Role</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="pl-2 pt-4">
                                ...
                                <Container>
                                    <Row>
                                        ...
                                        <Form style={{width:"400px", margin:"auto"}} className="pb-5" onSubmit={this.handleSubmit} >
                                            ...
                                            <Button className="text-white btn-outline-danger" block style={{ background: "#E50914"}} type="submit" >Kirim</Button>
                                        </Form>
                                        </Col>
                                    </Row>
                                </Container>
...
export default connect(mapStateToProps, { postTransaction })(ProfileAndPayment);
